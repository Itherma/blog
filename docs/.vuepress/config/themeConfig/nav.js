...
module.exports = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "《JavaScript高级程序设计》笔记", link: "/notes/js/" },
      { text: "《ES6 教程》笔记", link: "/notes/es6/" },
      { text: "《Vue》笔记", link: "/notes/vue/" },
      { text: "《TypeScript 从零实现 axios》", ink: "/notes/typescript-axios/" },
      { text: "《Git》学习笔记", link: "/notes/git/" },
      { text: "《渲染器原理》", link: "/notes/render/" },
      { text: "TypeScript笔记", link: "/notes/typeScript/" },
      { text: "JS设计模式总结笔记", link: "/notes/codeDesign/" },
    ],
  },
  {
    text: "其他技术",
