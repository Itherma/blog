...
![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/browser.7559b8c7.png)
...
![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/jd.f840386b.png)
...
![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/timg.5bac37a6.jpg)
...
![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/http-parser-2.398de592.png)

![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/http-parser-1.d9ff5d77.png)
...
![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/img/browerrender.jpg)
...
![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/timing-overview.7e63b017.png)
...
![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/rerender.da317d33.png)
...
1. 通过`async`、`defer`异步加载文件
   ...
   ![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/test.3ca4a381.png)
...
7. `requestAnimationFrame`、`requestIdleCallback`
   ...
   ![img](https://cdn.jsdelivr.net/gh/sunnyxujian/image-store/image/frame.99c33aee.png)
